...
public sealed class Player {
    ...
    private void CreateStartingDiggers(int numberOfDiggers) {
        ...
        Pos[] initialPositions = {new Pos(mPlayerPos.x-2,mPlayerPos.z-2), new Pos(mPlayerPos.x-2,mPlayerPos.z+2), new Pos(mPlayerPos.x+2,mPlayerPos.z+2), new Pos(mPlayerPos.x+2, mPlayerPos.z-2),
                                  new Pos(mPlayerPos.x-2,mPlayerPos.z+0), new Pos(mPlayerPos.x+0,mPlayerPos.z+2), new Pos(mPlayerPos.x+2,mPlayerPos.z+0), new Pos(mPlayerPos.x+0, mPlayerPos.z-2),
                                  new Pos(mPlayerPos.x-2,mPlayerPos.z+1), new Pos(mPlayerPos.x+1,mPlayerPos.z+2), new Pos(mPlayerPos.x+2,mPlayerPos.z-1), new Pos(mPlayerPos.x-1, mPlayerPos.z-2),
                                  new Pos(mPlayerPos.x-2,mPlayerPos.z-1), new Pos(mPlayerPos.x-1,mPlayerPos.z+2), new Pos(mPlayerPos.x+2,mPlayerPos.z+1), new Pos(mPlayerPos.x+1, mPlayerPos.z-2) };
